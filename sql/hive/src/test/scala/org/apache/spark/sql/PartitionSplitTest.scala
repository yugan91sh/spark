...
object PartitionSplitTest {
  ...
  def main(args: Array[String]): Unit = {
    val spark = SparkSession
      ...
      .config("spark.sql.splitSourcePartition.preferShuffle", "false")
      .config("spark.sql.splitSourcePartition.rowCount", "50000")
      .config("spark.sql.splitSourcePartition.num", "10")
